...
import com.miage.altea.game_ui.config.SecurityConfig;
...
class SecurityConfigTest {
    ...
    void userDetailsService_shouldUseTrainerService() {
        ...
        when(trainerService.getTrainerByName("Garry")).thenReturn(trainer);
        ...
        verify(trainerService).getTrainerByName("Garry");
